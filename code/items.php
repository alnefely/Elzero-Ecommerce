<?php 
	ob_start();
	session_start();
	$pageTitle = 'Show Items'; // Page Title
	include "init.php";
...
?>
	...
	<h1 class="text-center"><?php echo '<a href="items.php?itemid='. $item['Item_ID'] .'">'. $item['Name'] .'</a>' ?></h1>
	<div class="container">
		<div class="row">
			<div class="col-md-3">
						...
						<?php
							...
							foreach ($allTags as $tag) {
								...
								if(! empty($tag)) {
									...
									echo '<span class="no-tag">No Tags</span>';
								}
							}
						?>
					</li>
				...
				<div class="col-md-offset-3">
					<div class="add-comment">
						...
						<form action="<?php echo $_SERVER['PHP_SELF'] . '?itemid='. $item['Item_ID'] ?>" method="POST">
							<textarea required name="comment" class="form-control" placeholder=" Enter Your Comment"></textarea>
