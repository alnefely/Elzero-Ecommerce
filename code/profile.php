...
?>
								...
								echo '<div class="col-sm-6 col-md-3">';
									echo '<div class="thumbnail item-box">';
										...
										echo '<div class="caption">';
											echo '<h3><a href="items.php?itemid='. $ads['Item_ID'] .'">'. $ads['Name'] .'</a></h3>';
	...
	<div class="my-comments block" id="mycomment">
		<div class="container">
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					<?php 
						...
						if (! empty($myComments)) {
							...
							echo '<h4>There \'s No Comments To Show</h4>';
						}
					?>
				</div>
			</div>
